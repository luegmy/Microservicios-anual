...
public class GageProductAppApplication {

    //public static void main(String[] args) {
        //SpringApplication.run(GageProductAppApplication.class, args);

    private static final Logger LOG =
            LoggerFactory.getLogger(GageProductAppApplication.class);

    public static void main(String[] args) {
        ConfigurableApplicationContext ctx =SpringApplication.run(GageProductAppApplication.class, args);
